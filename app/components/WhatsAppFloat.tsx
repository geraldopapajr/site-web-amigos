...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-data-green text-ink shadow-glow-green transition hover:scale-105"
    >
